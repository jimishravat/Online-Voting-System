...
<head>
    ...
    <style>
        <?php include '../css/admin-candidates.css'; ?>
    </style>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Candidate</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 cand-table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $rows['position_id']  ?></td>
                                        <td><?php echo $rows['firstname'] . " " . $rows['lastname'] ?></td>
                                        <td><?php echo $rows['discription']  ?></td>

                                        <td><img src="data:photo/jpeg;base64,<?php echo base64_encode($rows['photo']); ?>" width="100" height="100" /></td>
